...
画面右上の「選曲が近い歌手を探す」から、全歌手を選曲類似度に基づく2次元マップで確認できます。点を選ぶと、その歌手と共通曲のある上位5人を線と一覧で表示します。マップは類似する歌手を引き寄せる力学配置で、軸や方向に意味はありません。正確な比較には一覧の類似度を使い、共通曲のリンクから相手の動画をYouTubeで開けます。
